...
agent any 
   ...
   tools {
    ...
    environment {
        ...
        GITHUB_DESPLIEGUE_URL = "https://github.com/dim-desarrollo/gestor-estaciones.git"
...
/*
    ...
    stage('Message start deploy') {
        ...
        steps {
            ...
            discordSend description: "Inicio de deploy!!!", footer: "Inicado", link: env.BUILD_URL, result: currentBuild.currentResult, title: "Deploy BackEnd-Estaciones", webhookURL: "https://discord.com/api/webhooks/1173648912838561922/iB8YUryvKbcj66EWQa2e6161BDuygkfaMx57VUalxPnDAMvoRHcYKxJTaxV4nfBEdoxi"
...
*/
    ...
    */
     ...
     stage('Build and run') {
        ...
        environment{
             PUERTO_INTERNO = 4000
             NOMBRE_CONTENEDOR = "gestor-estaciones"
             IDENTIFICADOR_IMAGEN = "gestor-estaciones"
         }
        ...
        steps {
            script {
                ...
                dir ("${CARPETA_APLICACION}"){
                    ...
                    sh "docker run --network estaciones_my-network-estaciones -d -p ${PUERTO_EXTERNO}:${PUERTO_INTERNO} --name ${NOMBRE_CONTENEDOR} ${IDENTIFICADOR_IMAGEN}"
